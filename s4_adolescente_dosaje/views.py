...
def obtener_avance_regional_mensual_s4_adolescente_dosaje():
    """
        ...
        with connection.cursor() as cursor:
            cursor.execute(
                '''
                    ...
                    FROM 
                    public."Cobertura_SI_04_AdolescenteDosaje";
                '''
            )
            resultados = cursor.fetchall()
...
def index_s4_adolescente_dosaje(request):
    ...
    if request.headers.get('x-requested-with') == 'XMLHttpRequest':
        try:
            ...
            # Obtener datos de AVANCE GRAFICO ANUAL
            resultados_avance_regional_mensual_s4_adolescente_dosaje = obtener_avance_regional_mensual_s4_adolescente_dosaje()
