            ...
            cursor.execute(
                '''
                    ...
                    CASE 
                        ...
                        , 2) 
                    END AS cob
                    FROM public."MC03_PaqueteNeonatal_Combinado"
					WHERE "año" = '2025'
                '''
            )
...
def obtener_avance_regional_mensual_paquete_neonatal(anio):
    """
...
def index_paquete_neonatal(request):
    ...
    if request.headers.get('x-requested-with') == 'XMLHttpRequest':
        try:
            ...
            resultados_avance_regional_paquete_neonatal = obtener_avance_regional_paquete_neonatal()
            # Obtener datos de AVANCE GRAFICO ANUAL
            resultados_avance_regional_mensual_paquete_neonatal = obtener_avance_regional_mensual_paquete_neonatal(anio)
            ...
            for index, row in enumerate(resultados_avance_regional_paquete_neonatal):
                try:
            ...
            for index, row in enumerate(resultados_avance_regional_mensual_paquete_neonatal):
                try:
                    # Verifica que el diccionario tenga las claves necesarias
...
def fill_worksheet(ws, results): 
    ...
    ws.merge_cells('K5:Z5')
    
    # Auxiliar HORIZONTAL
    ws.merge_cells('O6:O7')
    ws.merge_cells('X6:X7')
    ...
    ws['D6'] = 'Se excluye a niños y niñas con bajo peso al nacer (menor de 2500 gramos) y/o prematuros (menor de 37 SG), registrados en CNV en línea'
    ws['K6'] = 'Desde la fecha de nacimiento + 01 día'
    ws['M6'] = 'Desde la fecha de nacimiento + 01 día'
    ws['O6'] = 'NUMERADOR PARCIAL'
    ws['P6'] = '1° control CRED se realiza a partir del 3er día de vida, hasta los 28 dias de edad'
    ws['R6'] = '2° CRED con intervalo mínimo de 3 dias a partir del 1° control, hasta los 28 dias de edad'
    ws['T6'] = '3° CRED con un intervalo minimo de 7 dias a partir 2° control, hasta los 28 dias de edad'
    ws['V6'] = '4° CRED con un intervalo minimo de 7 dias a partir 3° control, hasta los 28 dias de edad'
    ws['X6'] = 'NUMERADOR PARCIAL'
    ws['Y6'] = 'A partir del 2do día (48 horas) hasta 6 días de nacido'
    
    ws['K7'] = 'DX = 90585'
    ws['M7'] = 'DX = 90744'
    ws['P7'] = 'DX = 99381.01 ó Z001'
    ws['R7'] = 'DX = 99381.01 ó Z001'
    ws['T7'] = 'DX = 99381.01 ó Z001'
    ws['V7'] = 'DX = 99381.01 ó Z001'
    ws['Y7'] = 'DX = 36416'
    ...
    ws['M6'].font = Font(name = 'Arial', size= 7)
    ws['M6'].fill = plomo_claro_fill
    ws['M6'].border = border_negro
    
    ws['O6'].alignment = Alignment(horizontal= "center", vertical="center", wrap_text=True)
    ws['O6'].font = Font(name = 'Arial', size= 7)
    ws['O6'].fill = plomo_claro_fill
    ws['O6'].border = border_negro
...
def obtener_cobertura_paquete_neonatal():
    with connection.cursor() as cursor:
        cursor.execute(
            'SELECT * FROM public."Cobertura_MC03_PaqueteNeonatal" ORDER BY "Red", "MicroRed", "Nombre_Establecimiento";'
        )
        return cursor.fetchall()

class RptCoberturaPaqueteNeonatal(TemplateView):
    def get(self, request, *args, **kwargs):
        # Variables ingresadas
                
        # Creación de la consulta
        resultado_cobertura = obtener_cobertura_paquete_neonatal()
        ...
        for index, (sheet_name, results) in enumerate(consultas):
            ...
            fill_worksheet_cobertura_paquete_neonatal(ws, results)
        
        ##########################################################################          
        # Establecer el nombre del archivo
        nombre_archivo = "rpt_cobertura_paquete_neonatal.xlsx"
        # Definir el tipo de respuesta que se va a dar
        response = HttpResponse(content_type="application/ms-excel")
        contenido = "attachment; filename={}".format(nombre_archivo)
        response["Content-Disposition"] = contenido
...
def fill_worksheet_cobertura_paquete_neonatal(ws, results): 
    # cambia el alto de la columna
    ws.row_dimensions[1].height = 14
    ws.row_dimensions[2].height = 14
    ...
    ws['B4'].alignment = Alignment(horizontal= "left", vertical="center")
    ws['B4'].font = Font(name = 'Arial', size= 12, bold = True)
    ws['B4'] = 'COBERURA DEL INDICADOR MC-03. PORCENTAJE DE RECIÉN NACIDOS DEL DEPARTAMENTO, RECIBEN VACUNAS BCG, HVB, CONTROLES CRED Y TAMIZAJE NEONATAL'
    ...
    ws['E8'] = 'N° de niños (recién nacidos) del denominador, que reciben vacunas BCG y HvB, Controles CRED y tamizaje neonata! (toma de muestra), registrados en HIS'
    
    ws['F8'].alignment = Alignment(horizontal= "center", vertical="center", wrap_text=True)
    ws['F8'].font = Font(name = 'Arial', size= 7, bold = True, color='000000')
    ws['F8'].fill = yellow_fill
    ws['F8'].border = border_negro
    ws['F8'] = 'N° de niños de 29 días de vida (recién nacidos), del departamento en el mes de medición, registrados en el padrón nominal (DNI o CNV en línea) y CNV en línea, con tipo de seguro MINSA'
    ...
    ws['H8'] = 'N° de niños (recién nacidos) del denominador, que reciben vacunas BCG y HvB, Controles CRED y tamizaje neonata! (toma de muestra), registrados en HIS'    
    
    ws['I8'].alignment = Alignment(horizontal= "center", vertical="center", wrap_text=True)
    ws['I8'].font = Font(name = 'Arial', size= 7, bold = True, color='000000')
    ws['I8'].fill = blue_fill
    ws['I8'].border = border_negro
    ws['I8'] = 'N° de niños de 29 días de vida (recién nacidos), del departamento en el mes de medición, registrados en el padrón nominal (DNI o CNV en línea) y CNV en línea, con tipo de seguro MINSA' 
    ...
    ws['K8'] = 'N° de niños (recién nacidos) del denominador, que reciben vacunas BCG y HvB, Controles CRED y tamizaje neonata! (toma de muestra), registrados en HIS'     
    
    ws['L8'].alignment = Alignment(horizontal= "center", vertical="center", wrap_text=True)
    ws['L8'].font = Font(name = 'Arial', size= 7, bold = True, color='000000')
    ws['L8'].fill = blue_fill
    ws['L8'].border = border_negro
    ws['L8'] = 'N° de niños de 29 días de vida (recién nacidos), del departamento en el mes de medición, registrados en el padrón nominal (DNI o CNV en línea) y CNV en línea, con tipo de seguro MINSA' 
    ...
    ws['N8'] = 'N° de niños (recién nacidos) del denominador, que reciben vacunas BCG y HvB, Controles CRED y tamizaje neonata! (toma de muestra), registrados en HIS'   
    
    ws['O8'].alignment = Alignment(horizontal= "center", vertical="center", wrap_text=True)
    ws['O8'].font = Font(name = 'Arial', size= 7, bold = True, color='000000')
    ws['O8'].fill = blue_fill
    ws['O8'].border = border_negro
    ws['O8'] = 'N° de niños de 29 días de vida (recién nacidos), del departamento en el mes de medición, registrados en el padrón nominal (DNI o CNV en línea) y CNV en línea, con tipo de seguro MINSA'
    ...
    ws['Q8'] = 'N° de niños (recién nacidos) del denominador, que reciben vacunas BCG y HvB, Controles CRED y tamizaje neonata! (toma de muestra), registrados en HIS'   
    
    ws['R8'].alignment = Alignment(horizontal= "center", vertical="center", wrap_text=True)
    ws['R8'].font = Font(name = 'Arial', size= 7, bold = True, color='000000')
    ws['R8'].fill = blue_fill
    ws['R8'].border = border_negro
    ws['R8'] = 'N° de niños de 29 días de vida (recién nacidos), del departamento en el mes de medición, registrados en el padrón nominal (DNI o CNV en línea) y CNV en línea, con tipo de seguro MINSA' 
    ...
    ws['T8'] = 'N° de niños (recién nacidos) del denominador, que reciben vacunas BCG y HvB, Controles CRED y tamizaje neonata! (toma de muestra), registrados en HIS'    
    
    ws['U8'].alignment = Alignment(horizontal= "center", vertical="center", wrap_text=True)
    ws['U8'].font = Font(name = 'Arial', size= 7, bold = True, color='000000')
    ws['U8'].fill = blue_fill
    ws['U8'].border = border_negro
    ws['U8'] = 'N° de niños de 29 días de vida (recién nacidos), del departamento en el mes de medición, registrados en el padrón nominal (DNI o CNV en línea) y CNV en línea, con tipo de seguro MINSA'
    ...
    ws['W8'] = 'N° de niños (recién nacidos) del denominador, que reciben vacunas BCG y HvB, Controles CRED y tamizaje neonata! (toma de muestra), registrados en HIS'   
        
    ws['X8'].alignment = Alignment(horizontal= "center", vertical="center", wrap_text=True)
    ws['X8'].font = Font(name = 'Arial', size= 7, bold = True, color='000000')
    ws['X8'].fill = blue_fill
    ws['X8'].border = border_negro
    ws['X8'] = 'N° de niños de 29 días de vida (recién nacidos), del departamento en el mes de medición, registrados en el padrón nominal (DNI o CNV en línea) y CNV en línea, con tipo de seguro MINSA'
    ...
    ws['Z8'] = 'N° de niños (recién nacidos) del denominador, que reciben vacunas BCG y HvB, Controles CRED y tamizaje neonata! (toma de muestra), registrados en HIS'   

    ws['AA8'].alignment = Alignment(horizontal= "center", vertical="center", wrap_text=True)
    ws['AA8'].font = Font(name = 'Arial', size= 7, bold = True, color='000000')
    ws['AA8'].fill = blue_fill
    ws['AA8'].border = border_negro
    ws['AA8'] = 'N° de niños de 29 días de vida (recién nacidos), del departamento en el mes de medición, registrados en el padrón nominal (DNI o CNV en línea) y CNV en línea, con tipo de seguro MINSA'
    ...
    ws['AC8'] = 'N° de niños (recién nacidos) del denominador, que reciben vacunas BCG y HvB, Controles CRED y tamizaje neonata! (toma de muestra), registrados en HIS'   
    
    ws['AD8'].alignment = Alignment(horizontal= "center", vertical="center", wrap_text=True)
    ws['AD8'].font = Font(name = 'Arial', size= 7, bold = True, color='000000')
    ws['AD8'].fill = blue_fill
    ws['AD8'].border = border_negro
    ws['AD8'] = 'N° de niños de 29 días de vida (recién nacidos), del departamento en el mes de medición, registrados en el padrón nominal (DNI o CNV en línea) y CNV en línea, con tipo de seguro MINSA'
    ...
    ws['AF8'] = 'N° de niños (recién nacidos) del denominador, que reciben vacunas BCG y HvB, Controles CRED y tamizaje neonata! (toma de muestra), registrados en HIS'   
    
    ws['AG8'].alignment = Alignment(horizontal= "center", vertical="center", wrap_text=True)
    ws['AG8'].font = Font(name = 'Arial', size= 7, bold = True, color='000000')
    ws['AG8'].fill = blue_fill
    ws['AG8'].border = border_negro
    ws['AG8'] = 'N° de niños de 29 días de vida (recién nacidos), del departamento en el mes de medición, registrados en el padrón nominal (DNI o CNV en línea) y CNV en línea, con tipo de seguro MINSA' 
    ...
    ws['AI8'] = 'N° de niños (recién nacidos) del denominador, que reciben vacunas BCG y HvB, Controles CRED y tamizaje neonata! (toma de muestra), registrados en HIS'    
    ...
    ws['AJ8'] = 'N° de niños de 29 días de vida (recién nacidos), del departamento en el mes de medición, registrados en el padrón nominal (DNI o CNV en línea) y CNV en línea, con tipo de seguro MINSA'
    ...
    ws['AL8'] = 'N° de niños (recién nacidos) del denominador, que reciben vacunas BCG y HvB, Controles CRED y tamizaje neonata! (toma de muestra), registrados en HIS'    
    ...
    ws['AM8'] = 'N° de niños de 29 días de vida (recién nacidos), del departamento en el mes de medición, registrados en el padrón nominal (DNI o CNV en línea) y CNV en línea, con tipo de seguro MINSA'
    ...
    ws['AO8'] = 'N° de niños (recién nacidos) del denominador, que reciben vacunas BCG y HvB, Controles CRED y tamizaje neonata! (toma de muestra), registrados en HIS'   
    ...
    ws['AP8'] = 'N° de niños de 29 días de vida (recién nacidos), del departamento en el mes de medición, registrados en el padrón nominal (DNI o CNV en línea) y CNV en línea, con tipo de seguro MINSA' 
