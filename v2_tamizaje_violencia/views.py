...
def obtener_avance_regional_mensual_v2_tamizaje_violencia():
    """
        ...
        with connection.cursor() as cursor:
            cursor.execute(
                '''
                    ...
                    FROM 
                    public."Cobertura_VI0102_TamizajeViolenciaGestante";
                '''
            )
            resultados = cursor.fetchall()
...
def index_v2_tamizaje_violencia(request):
    ...
    if request.headers.get('x-requested-with') == 'XMLHttpRequest':
        try:
            ...
            # Obtener datos de AVANCE GRAFICO ANUAL
            resultados_avance_regional_mensual_v2_tamizaje_violencia = obtener_avance_regional_mensual_v2_tamizaje_violencia()
