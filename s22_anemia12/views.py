            ...
            cursor.execute(
                '''
                    ...
                    CASE 
                        ...
                        , 2) 
                    END AS cob
                    FROM public."SI_0202_Anemia12M_Combinado"
					WHERE "año" = '2025'
                '''
            )
...
def obtener_avance_regional_mensual_s22_anemia12(anio):
    """
...
def index_s22_anemia12(request):
    ...
    if request.headers.get('x-requested-with') == 'XMLHttpRequest':
        try:
            ...
            # Obtener datos de AVANCE GRAFICO ANUAL
            resultados_avance_regional_mensual_s22_anemia12 = obtener_avance_regional_mensual_s22_anemia12(anio)
