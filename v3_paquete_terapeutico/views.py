    ...
    try:
        ...
        with connection.cursor() as cursor:
            cursor.execute(
                ...
                FROM public."Cobertura_VII0101_PaqueteTerapeutico"
                '''
            )
...
def obtener_avance_regional_mensual_v3_paquete_terapeutico():
    """
        ...
        with connection.cursor() as cursor:
            cursor.execute(
                '''
                    ...
                    FROM 
                    public."Cobertura_VII0101_PaqueteTerapeutico";
                '''
            )
            resultados = cursor.fetchall()
...
def index_v3_paquete_terapeutico(request):
    ...
    if request.headers.get('x-requested-with') == 'XMLHttpRequest':
        try:
            ...
            # Obtener datos de AVANCE GRAFICO ANUAL
            resultados_avance_regional_mensual_v3_paquete_terapeutico = obtener_avance_regional_mensual_v3_paquete_terapeutico()
