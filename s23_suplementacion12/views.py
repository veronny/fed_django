            ...
            cursor.execute(
                '''
                    ...
                    CASE 
                        ...
                        , 2) 
                    END AS cob
                    FROM public."SI_0203_Suplementacion12M_Combinado"
					WHERE "año" = '2025'
                '''
            )
...
def obtener_avance_regional_mensual_s23_suplementacion12(anio):
    """
...
def index_s23_suplementacion12(request):
    ...
    if request.headers.get('x-requested-with') == 'XMLHttpRequest':
        try:
            ...
            # Obtener datos de AVANCE GRAFICO ANUAL
            resultados_avance_regional_mensual_s23_suplementacion12 = obtener_avance_regional_mensual_s23_suplementacion12(anio)
