...
def obtener_avance_regional_mensual_s1_gestante_anemia(anio):
    """
...
def index_s1_gestante_anemia(request):
    ...
    if request.headers.get('x-requested-with') == 'XMLHttpRequest':
        try:
            ...
            # Obtener datos de AVANCE GRAFICO ANUAL
            resultados_avance_regional_mensual_s1_gestante_anemia = obtener_avance_regional_mensual_s1_gestante_anemia(anio)
